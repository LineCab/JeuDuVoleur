...
{
	public int Pv = 3; //Nombre de points du personnage
    ...
    void OnTriggerEnter2D(Collider2D col) {
        ...
        if (col.gameObject.tag == "Player") {
			...
			col.gameObject.GetComponent<PlayerManager>().RemoveLife(); //On récupère le PlayerManager du joueur pour ajouter la mort
